    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!!Form::open(['route'=>'auditoria.update','method'=>'put'])!!}
                <div class="form-group col">
                    {!!Form::hidden('idCatComponente',$componente->id)!!}
                    {!!Form::hidden('idAuditoria',"",['id'=>'idAuditoriaEdit'])!!}
                    {!!Form::label('nombre','NUEVO NOMBRE:')!!}
                    {!! Form::text('nombre', null, ['id'=>'nombreEdit','class' => 'form-control mayus','required']) !!}
                </div>
            </div>
            <!-- Modal footer -->
...
@stop
@include('auditoria.componente.scripts')
